...
namespace constants
{
  ...
  // Dimensional
  inline constexpr double rodGrwthRtePreFac{ 4 };         // microns / hour
  ...
  inline constexpr double nondim_kappa { 10 }; // this is the spring constant

  // ------------------------- Integration Constants ---------------------------

  // Biofilm specific constants
  inline constexpr double colony_size_target{ 100500.0 };
